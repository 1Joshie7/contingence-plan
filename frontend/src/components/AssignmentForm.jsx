  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      <form onSubmit={handleSubmit} className="space-y-8">
        {/* Basic Information Card - Premium */}
        ...
        {/* Course Information Card - Premium */}
        <div className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 px-6 py-4 border-b border-gray-100">
            <div className="flex items-center gap-2">
        ...
        {/* Grading Configuration Card - Premium */}
        <div className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 px-6 py-4 border-b border-gray-100">
            <div className="flex items-center gap-2">
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-md font-medium text-gray-700">Weights (total: {totalWeight}%)</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {Object.entries(weights).map(([key, val]) => (
                  <div key={key} className="flex items-center justify-between gap-3 p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    ...
                    <input
                      ...
                      min="0"
                      max="100"
                      className="w-24 border rounded-lg px-2 py-1 text-right focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                    />
                  </div>
                ))}
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-md font-medium text-gray-700">Function Requirements</h3>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-6">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleFuncReqChange}
                        className="w-full border rounded-lg px-2 py-1 focus:ring-2 focus:ring-indigo-500 transition-all"
                      />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-600 mb-1">Parameter Count</label>
                      <input
                        type="number"
                        name="param_count"
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-md font-medium text-gray-700">Additional Checks</h3>
              </div>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
        ...
        <div className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden">
          ...
          <div className="p-6">
            <div className="bg-gradient-to-br from-gray-50 to-indigo-50/30 rounded-xl p-5 mb-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 transition-all"
                  >
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center gap-1 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-4 py-2 rounded-lg transition-all shadow-md hover:shadow-lg"
                  >
                  ...
                  {editingTestCase && (
                    <button
                      ...
                      className="flex items-center gap-1 bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg transition-all"
                    >
                      <X className="h-4 w-4" />
                      Cancel
                    </button>
            ...
            {mode === 'edit' && loadingTestCases && <div className="text-center py-4 text-gray-500">Loading test cases...</div>}
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {displayTestCases.map((tc) => (
                      <tr key={tc.id} className="hover:bg-gray-50 transition-all">
                        ...
                        <td className="px-4 py-3 text-sm">
                          <div className="flex gap-2">
                            <button onClick={() => editTestCase(tc)} className="text-indigo-600 hover:text-indigo-800 transition-all">
                              <Edit className="h-4 w-4" />
                            </button>
                            <button onClick={() => deleteTestCase(tc)} className="text-red-600 hover:text-red-800 transition-all">
        ...
        <div className="flex gap-4 justify-end">
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold py-2 px-6 rounded-lg transition-all disabled:opacity-50 shadow-md hover:shadow-lg"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-2 px-6 rounded-lg transition-all"
          >
            <X className="h-5 w-5" />
            Cancel
          </button>
